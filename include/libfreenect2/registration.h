...
public:
  ...
  void apply512_424(const Frame* rgb, const Frame* depth, Frame* undistorted, Frame* registered, const bool enable_filter = false, Frame* bigdepth = 0, int* color_depth_map = 0) const;
  void apply512_363(const Frame* rgb, const Frame* depth, Frame* undistorted, Frame* registered, const bool enable_filter = false, Frame* bigdepth = 0, int* color_depth_map = 0) const;
  void apply640_480(const Frame* rgb, const Frame* depth, Frame* undistorted, Frame* registered, const bool enable_filter = false, Frame* bigdepth = 0, int* color_depth_map = 0) const;
